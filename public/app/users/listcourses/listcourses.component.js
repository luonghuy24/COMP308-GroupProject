            ...
            ListCoursesComponent = (function () {
                ...
                ListCoursesComponent.prototype.ngOnInit = function () {
                    ...
                    this._route.queryParams.subscribe(function (params) {
                        _this.patientName = params['patientName'];
                        _this.patient = params['patientId'];
                    });
                };
                ...
                ListCoursesComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [users_service_1.UsersService, authentication_service_1.AuthenticationService, router_1.Router, router_1.ActivatedRoute])
