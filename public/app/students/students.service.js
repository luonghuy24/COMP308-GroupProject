    ...
    return {
        ...
        execute: function() {
            StudentsService = (function () {
                ...
                StudentsService.prototype.create = function (article) {
                    return this._http
                        .post(this._baseURL, article)
                        .map(function (res) { return res.json(); })
                        .catch(this.handleError);
                };
                StudentsService.prototype.read = function (articleId) {
                    return this._http
                        .get(this._baseURL + "/" + articleId)
                        .map(function (res) { return res.json(); })
                        .catch(this.handleError);
                };
                StudentsService.prototype.update = function (article) {
                    return this._http
                        .put(this._baseURL + "/" + article._id, article).map(function (res) { return res.json(); })
                        .catch(this.handleError);
                };
                StudentsService.prototype.delete = function (articleId) {
                    return this._http
