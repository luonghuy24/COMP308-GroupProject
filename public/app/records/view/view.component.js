System.register(["@angular/core", "@angular/router", "../../authentication/authentication.service", "../records.service"], function (exports_1, context_1) {
    ...
    var core_1, router_1, authentication_service_1, records_service_1, ViewComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
            ...
            ViewComponent = /** @class */ (function () {
                    ...
                    this.paramsObserver = this._route.params.subscribe(function (params) {
                        ...
                        _this._articlesService
                            ...
                            _this.allowEdit = (_this.user && _this.user._id === _this.
                                article.creator._id);
                        }, function (error) { return _this._router.navigate(['/records']); });
                    });
                };
                //
                ...
                ViewComponent.prototype.delete = function () {
                    ...
                    this._articlesService.delete(this.article._id).
                        subscribe(function (deletedArticle) { return _this._router.navigate(['/users', _this.user.id, 'records']); }, function (error) { return _this.errorMessage = error; });
                };
