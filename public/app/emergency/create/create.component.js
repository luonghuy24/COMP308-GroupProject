System.register(['@angular/core', '@angular/router', '../emergency.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, emergency_service_1;
    var CreateComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            CreateComponent = (function () {
                ...
                CreateComponent.prototype.create = function () {
                    ...
                    this._articlesService
                        .create(this.article)
                        .subscribe(function (createdArticle) { return _this._router.navigate(['/emergency',
                ...
                CreateComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.Router, emergency_service_1.EmergencyService])
                ], CreateComponent);
